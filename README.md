...
I am also willing to relocate to Malta permanently.

I am passionate about solving problems, and have a relentless drive to excel in the tech industry. 
Taking into consideration good software design, user experience, debugging, optimization and maintainability. 
I feel comfortable working with HTML, CSS, partial JavaScript both on the server and front-end. Plus basic PHP. 
I'm eager to learn new cutting-edge technologies and stay ahead of the ever-changing trends in Web Development. 
My ultimate goal is to build reliable and maintainable Front-end applications, that are both functionally and aesthetically pleasing.
